 ...
 -->
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="#">
                                <img src="assets/images/logo1.png" alt="Logo" height="50px" width="280px">
                            </a>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarEight">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#pricing">WHY IFMS?</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#testimonial">CONTACT</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="https://wa.me/9714701407?text=Hello_IFMS">
                                            <img src="assets/images/waicon.png" height="30px" width="30px">
                                        </a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="bd-example">
                <div id="carouselOne" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item bg_cover active" style="background-image: url(assets/images/s1.png)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">We Provide the Services for Commercial and Residential Spaces.</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <li><a class="main-btn rounded-three" href="#">All Services</a></li>
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(assets/images/wire.png)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Electrical Operations and Maintenance.</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <li><a class="main-btn rounded-three" href="#">all Services</a></li>
                                                <!-- <li><a class="main-btn rounded-one" href="#">DOWNLOAD</a></li> -->
                                            </ul>
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(assets/images/pest_control.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Our integrated Pest Control Services Protect your Premises, Products and goods.</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <li><a class="main-btn rounded-three" href="#">All Services</a></li>
                                                <!-- <li><a class="main-btn rounded-one" href="#">DOWNLOAD</a></li> -->
                                            </ul>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div class="section-title text-center mt-30 pb-40">
                        <h4 class="title wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.6s">Something About Us.</h4>
                        <br>
                        <p class="text wow fadeInUp text-justify p-2" style="line-height:1.6" data-wow-duration="1.5s" data-wow-delay="1s">IFMS is a young and fast growing organisation backed by professionals with rich relevant operational experience in various industries and Indian Armed forces.
                        <b>IFMS</b> is one of the few companies which understands the <b>business of facility management</b> and strives to provide best solutions and services for its clients, in residential and commercial spaces. It <b>provides one stop shop solutions as per the need and requirement of clients.</b> </p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
    ...
    <section id="portfolio" class="portfolio-area">
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 security-services planning-3 services pricing-style-one mt-40 wow fadeIn">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/building.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                ...
                <div class="col-lg-4 col-sm-6 soft-services pricing-style-one mt-40 wow fadeIn">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="portfolio-image">
                            <img src="assets/images/soft_service.jpg" alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/soft_service.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <!-- <a href="#"><i class="lni-link"></i></a> -->
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 pest-services pricing-style-one mt-40 wow fadeIn">
                ...
                <div class="col-lg-4 col-sm-6 business-services pricing-style-one mt-40 wow fadeIn">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="portfolio-image">
                            <img src="assets/images/bman.jpg" alt="" height="220px">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/bman.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <!-- <a href="#"><i class="lni-link"></i></a> -->
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 technical-services pricing-style-one mt-40 wow fadeIn">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="portfolio-image">
                ...
                <div class="col-lg-4 col-sm-6 special-services pricing-style-one mt-40 wow fadeIn" style="border-shadow:none">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        <div class="portfolio-image">
                            ...
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href="assets/images/property.jpg"><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <!-- <a href="#"><i class="lni-link"></i></a> -->
                                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title pb-20">
                        ...
                        <br>
                        <p>IFMS is backed with experience of Ex-servicemen from the Indian Armed Forces
                            Integrated Solutions for all residential and commercial space management.
                        </p>
                        <br>
                        <ul>
                            <li><b>At IFMS safety is our prime focus and priority.</b></li>
                            <li><b>Process driven approach.</b></li>
                            <li><b>IFMS is specialised at optimum cost utility.</b></li>
                            <li><b>Professional service delivery with quality.</b></li>
                            <li><b>Streamlined operations.</b></li>
                            <li><b>Flat, flexible and interactive organisation.</b></li>
                        </ul>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-lg-6">
                    <div class="contact-two mt-50 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        ...
                        <ul class="contact-info">
                            ...
                            <li><i class="lni-envelope"></i> ops.ifms@gmail.com</li>
                        </ul>
                    </div> <!-- contact two -->
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="footer-link">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Hygiene & Soft Services</a></li>
                                <li><a href="#">Pest Management</a></li>
                                <li><a href="#">Specialised Services</a></li>
                                <li><a href="#">Business Support Solutions</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-2">
                        <div class="footer-logo text-center mt-10">
                            <a href="#home"><img src="assets/images/logo1.png" alt="Logo"></a>
                        </div> <!-- footer logo -->
                    </div>
                    <div class="col-lg-5">
